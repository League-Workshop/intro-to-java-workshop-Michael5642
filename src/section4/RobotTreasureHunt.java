...
franky.microMove(20);
	...
	private void spaceBarWasPressed() {
		...
		int robotXLocation = franky.getX();
		int robotYLocation = franky.getY();
		...
		if (robotXLocation<731 & robotXLocation>709
	       & robotYLocation<461 & robotYLocation>399) {JOptionPane.showMessageDialog(null, "go blow up the crack in the ground with the little boy");}
		// 8. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
		if (robotXLocation<381 & robotXLocation>209
			& robotYLocation<461 &	robotYLocation>189) {JOptionPane.showMessageDialog(null, 
			"the boy ignites the stick of dynamite");
			JOptionPane.showMessageDialog(null, "BOOM");
			JOptionPane.showMessageDialog(null, "the hole reveals buried treasure"); 
